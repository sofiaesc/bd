...
create table persona (
	...
	constraint fk_persona_references_localidad foreign key (codigo_provincia,codigo_localidad) references localidad (codigo_provincia,codigo_localidad)
);

create index idx_persona_localidad on persona (codigo_provincia,codigo_localidad);